...
{\small\textbf{Production record.} Evidence search: 8 September 2026. Separate source and methods agent reviews and original LaTeX compilation: 9 September 2026. The proposal was developed during the agent-assisted workshop preparation and revised following the source and methods reviews. The reusable literature-audit skill was written afterward to describe the workflow; it did not generate this original document. The accompanying coauthor dialogue is a scripted teaching example, not a transcript of the researcher. This production note was added on 15 September; the literature search has not been refreshed.}
